...
​	而**除了我们刚刚用到的 PID Namespace，Linux 操作系统还提供了 Mount、UTS、IPC、Network 和 User 这些 Namespace，用来对各种不同的进程上下文进行“障眼法”操作。在生产环境中，网络Network Namespace出现问题的可能性更大一点**

​	比如，Mount Namespace，用于让被隔离进程只看到当前 Namespace 里的挂载点信息；Network Namespace，用于让被隔离进程看到当前 Namespace 里的网络设备和配置。

​	所以说，**容器，其实是一种特殊的进程而已。在Linux中，Docker其实就是通过Docker daemon fork了一个子进程**
